...
export const DepartmentsSection = () => {
  return (
    <section className={'grid grid-cols-1 gap-10 p-10 lg:grid-cols-2'}>
      <LinkBgCard
        imgSrc={dep01Img.src}
        title="영아부"
        subtitle={
      ...
      <LinkBgCard
        ...
        subtitle={
          <p>
            5세부터 7세까지의 어린이들이 말씀을 <br /> 바르게 배워 견고한 믿음을 세워가는 곳입니다.
          </p>
        }
      />
      ...
      <LinkBgCard
        ...
        subtitle={
          <p>
            예수님의 사랑 안에서 이웃 청년들이 깃들 수 있는 <br /> 넓은 품으로 함께 지어져 가는 사랑
            공동체 입니다.
          </p>
        }
      />
